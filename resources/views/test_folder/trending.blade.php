            ...
            <div class="card-content">
                <div class="card-header" style="background-color: white; border-bottom: none">
                   <div class="row">
                       ...
                       <div class="col-7 my-auto pl-5">
                           <h3 class="text-primary mb-3">@Zim_1</h3>
                ...
                <div class="card-desc">
                    <h3>Dear Mr President</h3>
                     ...
                     voluptas totam. this is a test of what happens when the text becomes too long. obviously i could have used ipsum loreum. but hey i am creig</p>
                    <a href="#" class="btn-card">Read</a>
                    <a href="#" class="active float-right" >Comments (5)</a>
                </div>
            </div>
        {{--</div>--}}
        {{--<div class="col-md-2">--}}
        ...
        <div class="card-content">
            <div class="card-header" style="background-color: white; border-bottom: none">
                <div class="row">
                    ...
                    <div class="col-7 my-auto pl-5">
                        <h3 class="text-primary">@Zim_1</h3>
                        <span class="text-muted">5 days ago</span>
                    </div>
                </div>
            </div>
