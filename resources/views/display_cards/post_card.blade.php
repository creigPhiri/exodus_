    ...
    <div class="col-12">
        @if(Auth::check())
            <div class="row">
                ...
                <!----***  image container-------->
                    <div class="col-3 mx-auto my-auto"><img src="{{asset('images/default_profile.png')}}" class="img-responsive card-img" alt="profile pic"></div>
                <!-- end of img arear--------->
                ...
                <!-- comment comment -->
                         <div class="col-9 ml-0 mt-2" style="border:3px solid #eee;box-shadow :0 2px 3px #ccc;">
                            <p class="media-body pb-3 mb-0 lh-125 border-bottom border-gray">
                               ...
                               <small class="text-muted float-right">{{$post->created_at->diffforhumans()}}</small>
                            </p>
                 ...
                 <!--******* delete and edit buttons ***--->
                               ...
                               <div class="row">
                                   <div class="col ml-5">@include('display_cards.comment_card')
                                </div>
                         </div>
                </div>
            </div>
